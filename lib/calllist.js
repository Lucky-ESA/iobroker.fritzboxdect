...
class Calllist extends EventEmitter {
    ...
    async createCallList(result) {
        ...
        if (result && result.root && result.root.call && Array.isArray(result.root.call)) {
            ...
            this.adapter.setState(`${this.config.dp}.TR_064.Calllists.incomming.count`, count_inbound, true);
            this.adapter.setState(`${this.config.dp}.TR_064.Calllists.outgoing.count`, count_outbound, true);
            this.adapter.setState(`${this.config.dp}.TR_064.Calllists.missed.count`, count_missed, true);
            ...
            this.adapter.setState(`${this.config.dp}.TR_064.Calllists.missed.json`, JSON.stringify(arr_missed), true);
        }
    }
