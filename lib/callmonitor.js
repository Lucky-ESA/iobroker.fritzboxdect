    ...
    createEvent(evt, date, connectionId, line, splitLines) {
        ...
        switch (evt) {
            ...
            case "PickUp":
                ...
                return this.call_events[connectionId];
            case "Ring":
                if (!splitLines[4].startsWith("00") && splitLines[4].startsWith("0")) {
                    if (this.constants[`Z${splitLines[4].substring(0, 6)}`]) {
                        this.call_events[connectionId].prefix = splitLines[4].substring(0, 6);
                        this.call_events[connectionId].state = this.constants[`Z${splitLines[4].substring(0, 6)}`];
                    } else if (this.constants[`Z${splitLines[4].substring(0, 5)}`]) {
                        this.call_events[connectionId].prefix = splitLines[4].substring(0, 5);
                        this.call_events[connectionId].state = this.constants[`Z${splitLines[4].substring(0, 5)}`];
                    } else if (this.constants[`Z${splitLines[4].substring(0, 4)}`]) {
                        this.call_events[connectionId].prefix = splitLines[4].substring(0, 4);
                        this.call_events[connectionId].state = this.constants[`Z${splitLines[4].substring(0, 4)}`];
                    } else if (this.constants[`Z${splitLines[4].substring(0, 3)}`]) {
                        this.call_events[connectionId].prefix = splitLines[4].substring(0, 3);
                        this.call_events[connectionId].state = this.constants[`Z${splitLines[4].substring(0, 3)}`];
                    }
                }
