module.exports = {
    ...
    async createCallmonitor(id) {
        ...
        await this.createDataPoint(`${id.dp}.TR_064.Callmonitor.connect.callee`, common, "state", null);
        await this.createDataPoint(`${id.dp}.TR_064.Callmonitor.lastcall.callee`, common, "state", null);
        await this.createDataPoint(`${id.dp}.TR_064.Callmonitor.outbound.callee`, common, "state", null);
        await this.createDataPoint(`${id.dp}.TR_064.Callmonitor.inbound.callee`, common, "state", null);
        common = {
            name: {
                en: "Callee name",
                de: "Angerufener Name",
        ...
        await this.createDataPoint(`${id.dp}.TR_064.Callmonitor.connect.calleename`, common, "state", null);
        await this.createDataPoint(`${id.dp}.TR_064.Callmonitor.lastcall.calleename`, common, "state", null);
        await this.createDataPoint(`${id.dp}.TR_064.Callmonitor.outbound.calleename`, common, "state", null);
        await this.createDataPoint(`${id.dp}.TR_064.Callmonitor.inbound.calleename`, common, "state", null);
        common = {
            name: {
                en: "Caller",
                de: "Anrufer",
        ...
        await this.createDataPoint(`${id.dp}.TR_064.Callmonitor.lastcall.duration`, common, "state", null);
        await this.createDataPoint(`${id.dp}.TR_064.Callmonitor.outbound.duration`, common, "state", null);
        common = {
            name: {
                en: "Type",
                de: "Typ",
            ...
            write: false,
            def: "",
            states: ["Ring", "Call", "PickUp", "HangUp"],
        };
        ...
        await this.createDataPoint(`${id.dp}.TR_064.Callmonitor.calldata`, common, "state", "{}");
    },
    /**
     * @param {object} id
     * @param {object} login
