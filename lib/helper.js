module.exports = {
    ...
    async createStateTR064(id) {
        ...
        await this.createDataPoint(`${id.dp}.TR_064.States.Traffic.upload`, common, "state", "");
        common = {
            name: {
                en: "Download speed",
        ...
        await this.createDataPoint(`${id.dp}.TR_064.States.Traffic.download`, common, "state", "");
        common = {
            name: {
                en: "Firmware",
                de: "Firmware",
