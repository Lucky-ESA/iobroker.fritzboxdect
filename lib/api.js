            ...
            if (fullConst != null && fullConst[1] != null) {
                try {
                    ...
                    for (const val in json) {
                        ...
                        if (val === "Today") all[val].id = 1;
                        else if (val === "Yesterday") all[val].id = 2;
                        else if (val === "ThisWeek") all[val].id = 3;
                        else if (val === "ThisMonth") all[val].id = 4;
                        else if (val === "LastMonth") all[val].id = 5;
