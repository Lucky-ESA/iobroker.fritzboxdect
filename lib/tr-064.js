            ...
            .then((result) => {
                ...
                if (
                    ...
                    if (val.newsyncgroupmode) {
                        this.adapter.setState(
                            `${this.config.dp}.TR_064.States.Traffic.groupmode`,
                    ...
                    if (val.newds_current_bps) {
                        this.adapter.setState(
                            `${this.config.dp}.TR_064.States.Traffic.newds_current_bps`,
                    ...
                    if (val.newmc_current_bps) {
                        this.adapter.setState(
                            `${this.config.dp}.TR_064.States.Traffic.newmc_current_bps`,
                    ...
                    if (val.newus_current_bps) {
                        this.adapter.setState(
                            `${this.config.dp}.TR_064.States.Traffic.newus_current_bps`,
                    ...
                    if (val.newprio_realtime_bps) {
                        this.adapter.setState(
                            `${this.config.dp}.TR_064.States.Traffic.newprio_realtime_bps`,
                    ...
                    if (val.newprio_high_bps) {
                        this.adapter.setState(
                            `${this.config.dp}.TR_064.States.Traffic.newprio_high_bps`,
                    ...
                    if (val.newprio_default_bps) {
                        this.adapter.setState(
                            `${this.config.dp}.TR_064.States.Traffic.newprio_default_bps`,
                    ...
                    if (val.newprio_low_bps) {
                        this.adapter.setState(
                            `${this.config.dp}.TR_064.States.Traffic.newprio_low_bps`,
            ...
            .then((result) => {
                ...
                if (
                    ...
                    if (val.newwanaccesstype) {
                        this.adapter.setState(
                            `${this.config.dp}.TR_064.States.Traffic.accesstype`,
