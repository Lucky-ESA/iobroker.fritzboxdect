...
class TR064 extends EventEmitter {
    ...
    async updateTR064() {
        ...
        if (!this.checkvalue[right] || this.checkvalue[right] != JSON.stringify(this.rights)) {
            this.checkvalue[right] = JSON.stringify(this.rights);
            await this.adapter.setStateAsync(right, JSON.stringify(this.rights), true);
        }
