                ...
                .then(async (result) => {
                    ...
                    if (result["s:envelope"]["s:body"]["u:x_avm-de_getcurrentuserresponse"]) {
                        ...
                        if (right && right.rights && right.rights.path) {
                            ...
                            const state = `${this.config.dp}.TR_064.States.rights`;
                            if (!this.checkvalue[state] || this.checkvalue[state] != JSON.stringify(this.rights)) {
                                this.checkvalue[state] = JSON.stringify(this.rights);
                                await this.adapter.setStateAsync(
